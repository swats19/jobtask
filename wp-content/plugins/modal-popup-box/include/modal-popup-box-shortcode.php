...
function awl_modal_popup_box_shortcode($post_id) {
	ob_start();
	//print_r($post_id);
	wp_enqueue_style('mbp-fronted-bootstrap-css', MPB_PLUGIN_URL . 'assets/css/fronted-bootstrap.css');
	...
	wp_enqueue_script('mbp-modernizr-custom-js', MPB_PLUGIN_URL .'assets/js/modal/modernizr.custom.js');	// before body load
	wp_enqueue_script('mbp-classie-js', MPB_PLUGIN_URL .'assets/js/modal/classie.js');
	wp_enqueue_script('mbp-cssParser-js', MPB_PLUGIN_URL .'assets/js/modal/cssParser.js');
